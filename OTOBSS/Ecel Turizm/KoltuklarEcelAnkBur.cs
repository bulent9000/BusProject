...
{
    public partial class KoltuklarEcelAnkBur : Form
    {
        OtobüsSistemServis service;
        string koltukN;
        int sonuc;
        MüsteriKayitEkrani müsteriKayitEkran;
        public KoltuklarEcelAnkBur()
        {
            InitializeComponent();
        ...
        private void müsteriKayit(string koltukNom, object sender)
        {
            ...
            GroupBox grpSirat = (GroupBox)frmAnkaraYön.Controls["grp_ecel"];
            ...
            Label lblyönEcel = (Label)grpSirat.Controls["lbl_yönEcel"]; //kalkış-varış yeri
            Label lblecelIsim = (Label)grpSirat.Controls["lbl_ecelIsim"]; //oto ismi
            Label lblsaatEcel = (Label)grpSirat.Controls["lbl_saatEcel"]; //oto saati
            Label lblücretEcel = (Label)grpSirat.Controls["lbl_ücretEcel"];
            Label lblecelKoltukDurum = (Label)grpSirat.Controls["lbl_ecelKoltukDurum"]; //2+1
            ...
            ((Label)grpMüsteriKayit.Controls["lbl_yön"]).Text = lblyönEcel.Text;
            ((Label)grpMüsteriKayit.Controls["lbl_otoAdi"]).Text = lblecelIsim.Text;
            ((Label)grpMüsteriKayit.Controls["lbl_kalkisSaati"]).Text = lblsaatEcel.Text;
            ((Label)grpMüsteriKayit.Controls["lbl_ücret"]).Text = lblücretEcel.Text;
            ((Label)grpMüsteriKayit.Controls["lbl_koltukBilgi"]).Text = lblecelKoltukDurum.Text;
            #endregion        
