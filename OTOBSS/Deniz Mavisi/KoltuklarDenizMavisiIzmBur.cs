...
{
    public partial class KoltuklarDenizMavisiIzmBur : Form
    {
        OtobüsSistemServis service;
        string koltukN;
        int sonuc;
        MüsteriKayitEkrani müsteriKayitEkran;
        public KoltuklarDenizMavisiIzmBur()
        {
            InitializeComponent();
        ...
        private void müsteriKayit(string koltukNom, object sender)
        {
            ...
            GroupBox grpdenizMavisi = (GroupBox)frmIzmirYön.Controls["grp_denizMavisi"];
            //Otobüsler sayfasındaki labeller alındı
            Label lblyönDenizMavisi = (Label)grpdenizMavisi.Controls["lbl_yönDenizMavisi"]; //kalkış-varış yeri
            Label lbldenizMavisiIsim = (Label)grpdenizMavisi.Controls["lbl_denizMavisiIsim"]; //oto ismi
            Label lblsaatDenizMavisi = (Label)grpdenizMavisi.Controls["lbl_saatDenizMavisi"]; //oto saati
            Label lblücretDenizMavisi = (Label)grpdenizMavisi.Controls["lbl_ücretDenizMavisi"];
            Label lbldenizMavisiKoltukDurum = (Label)grpdenizMavisi.Controls["lbl_denizMavisiKoltukDurum"]; //2+1
            müsteriKayitEkran = new MüsteriKayitEkrani();
            //müşteri kayıt ekranına aktarılıyor
           
            //Form frmMüsteriKayit = Application.OpenForms["MüsteriKayitEkrani"];
            ...
            ((Label)grpMüsteriKayit.Controls["lbl_yön"]).Text = lblyönDenizMavisi.Text;
            ((Label)grpMüsteriKayit.Controls["lbl_otoAdi"]).Text = lbldenizMavisiIsim.Text;
            ((Label)grpMüsteriKayit.Controls["lbl_kalkisSaati"]).Text = lblsaatDenizMavisi.Text;
            ((Label)grpMüsteriKayit.Controls["lbl_ücret"]).Text = lblücretDenizMavisi.Text;
            ((Label)grpMüsteriKayit.Controls["lbl_koltukBilgi"]).Text = lbldenizMavisiKoltukDurum.Text;
            #endregion        
