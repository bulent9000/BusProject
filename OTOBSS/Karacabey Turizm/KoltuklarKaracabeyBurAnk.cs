...
{
    public partial class KoltuklarKaracabeyBurAnk : Form
    {
        OtobüsSistemServis service;
        string koltukN;
        int sonuc;
        MüsteriKayitEkrani müsteriKayitEkran;
        public KoltuklarKaracabeyBurAnk()
        {
            InitializeComponent();
            müsteriKayitEkran = new MüsteriKayitEkrani();
        }

        private void kol1_Click_1(object sender, EventArgs e)
        {
            koltukN = kol1.Text;
        ...
        private void müsteriKayit(string koltukNom, object sender)
        {
            ...
            GroupBox grpkaracabey = (GroupBox)frmBursaYön.Controls["grp_karacabey"];
            ...
            Label lblyönKaracabey = (Label)grpkaracabey.Controls["lbl_yönKaracabey"]; //kalkış-varış yeri
            Label lblkaracabeyIsim = (Label)grpkaracabey.Controls["lbl_karacabeyIsim"]; //oto ismi
            Label lblsaatKaracabey = (Label)grpkaracabey.Controls["lbl_saatKaracabey"]; //oto saati
            Label lbl_ücretKaracabey = (Label)grpkaracabey.Controls["lbl_ücretKaracabey"];
            Label lbl_karacabeyKoltukDurum = (Label)grpkaracabey.Controls["lbl_karacabeyKoltukDurum"]; //2+1
            ...
            ((Label)grpMüsteriKayit.Controls["lbl_yön"]).Text = lblyönKaracabey.Text;
            ((Label)grpMüsteriKayit.Controls["lbl_otoAdi"]).Text = lblkaracabeyIsim.Text;
            ((Label)grpMüsteriKayit.Controls["lbl_kalkisSaati"]).Text = lblsaatKaracabey.Text;
            ((Label)grpMüsteriKayit.Controls["lbl_ücret"]).Text = lbl_ücretKaracabey.Text;
            ((Label)grpMüsteriKayit.Controls["lbl_koltukBilgi"]).Text = lbl_karacabeyKoltukDurum.Text;
            #endregion        
