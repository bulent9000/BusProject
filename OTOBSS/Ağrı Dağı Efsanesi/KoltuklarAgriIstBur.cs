...
{
    public partial class KoltuklarAgriIstBur : Form
    {
        OtobüsSistemServis service;
        string koltukN;
        int sonuc;
        MüsteriKayitEkrani müsteriKayitEkran;
        public KoltuklarAgriIstBur()
        {
            InitializeComponent();
        ...
        private void müsteriKayit(string koltukNom, object sender)
        {
            ...
            GroupBox grpAgri = (GroupBox)frmIstYön.Controls["grp_agri"];
            ...
            Label lblyönAgri = (Label)grpAgri.Controls["lbl_yönAgri"]; //kalkış-varış yeri
            Label lblagriDagiIsim = (Label)grpAgri.Controls["lbl_agriDagiIsim"]; //oto ismi
            Label lblsaatAgri = (Label)grpAgri.Controls["lbl_saatAgri"]; //oto saati
            Label lblücretAgri = (Label)grpAgri.Controls["lbl_ücretAgri"];
            Label lblagriKoltukDurum = (Label)grpAgri.Controls["lbl_agriKoltukDurum"]; //2+1
            ...
            ((Label)grpMüsteriKayit.Controls["lbl_yön"]).Text = lblyönAgri.Text;
            ((Label)grpMüsteriKayit.Controls["lbl_otoAdi"]).Text = lblagriDagiIsim.Text;
            ((Label)grpMüsteriKayit.Controls["lbl_kalkisSaati"]).Text = lblsaatAgri.Text;
            ((Label)grpMüsteriKayit.Controls["lbl_ücret"]).Text = lblücretAgri.Text;
            ((Label)grpMüsteriKayit.Controls["lbl_koltukBilgi"]).Text = lblagriKoltukDurum.Text;
            #endregion        
