...
{
    public partial class KoltuklarRetroAnkIst : Form
    {
        OtobüsSistemServis service;
        string koltukN;
        int sonuc;
        MüsteriKayitEkrani müsteriKayitEkran;
        public KoltuklarRetroAnkIst()
        {
            InitializeComponent();
        ...
        private void müsteriKayit(string koltukNom, object sender)
        {
            ...
            GroupBox grpSontur = (GroupBox)frmAnkaraYön.Controls["grp_retro"];
            ...
            Label lblyönRetro = (Label)grpSontur.Controls["lbl_yönRetro"]; //kalkış-varış yeri
            Label lblretroIsim = (Label)grpSontur.Controls["lbl_retroIsim"]; //oto ismi
            Label lblsaatRetro = (Label)grpSontur.Controls["lbl_saatRetro"]; //oto saati
            Label lbl_ücretRetro = (Label)grpSontur.Controls["lbl_ücretRetro"];
            Label lbl_retroKoltukDurum = (Label)grpSontur.Controls["lbl_retroKoltukDurum"]; //2+1
            ...
            ((Label)grpMüsteriKayit.Controls["lbl_yön"]).Text = lblyönRetro.Text;
            ((Label)grpMüsteriKayit.Controls["lbl_otoAdi"]).Text = lblretroIsim.Text;
            ((Label)grpMüsteriKayit.Controls["lbl_kalkisSaati"]).Text = lblsaatRetro.Text;
            ((Label)grpMüsteriKayit.Controls["lbl_ücret"]).Text = lbl_ücretRetro.Text;
            ((Label)grpMüsteriKayit.Controls["lbl_koltukBilgi"]).Text = lbl_retroKoltukDurum.Text;
            #endregion        
