...
{
    public partial class KoltuklarBizIstBur : Form
    {
        ...
        private void müsteriKayit(string koltukNom, object sender)
        {
            ...
            GroupBox grpBiz = (GroupBox)frmIstYön.Controls["grp_biz"];
            ...
            Label lblyönBiz = (Label)grpBiz.Controls["lbl_yönBiz"]; //kalkış-varış yeri
            Label lblbizIsim = (Label)grpBiz.Controls["lbl_bizIsim"]; //oto ismi
            Label lblsaatBiz = (Label)grpBiz.Controls["lbl_saatBiz"]; //oto saati
            Label lblücretBiz = (Label)grpBiz.Controls["lbl_ücretBiz"];
            Label lblbizKoltukDurum = (Label)grpBiz.Controls["lbl_bizKoltukDurum"]; //2+1
            ...
            ((Label)grpMüsteriKayit.Controls["lbl_yön"]).Text = lblyönBiz.Text;
            ((Label)grpMüsteriKayit.Controls["lbl_otoAdi"]).Text = lblbizIsim.Text;
            ((Label)grpMüsteriKayit.Controls["lbl_kalkisSaati"]).Text = lblsaatBiz.Text;
            ((Label)grpMüsteriKayit.Controls["lbl_ücret"]).Text = lblücretBiz.Text;
            ((Label)grpMüsteriKayit.Controls["lbl_koltukBilgi"]).Text = lblbizKoltukDurum.Text;
            #endregion        
