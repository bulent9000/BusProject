...
{
    public partial class KoltuklarTatilyaIzmBur : Form
    {
        OtobüsSistemServis service;
        string koltukN;
        int sonuc;
        MüsteriKayitEkrani müsteriKayitEkran;
        public KoltuklarTatilyaIzmBur()
        {
            InitializeComponent();
        ...
        private void müsteriKayit(string koltukNom, object sender)
        {
            ...
            GroupBox grpTatilya = (GroupBox)frmIzmirYön.Controls["grp_tatilya"];
            //Otobüsler sayfasındaki labeller alındı
            Label lblyönTatilya = (Label)grpTatilya.Controls["lbl_yönTatilya"]; //kalkış-varış yeri
            Label lbltatilyaIsim = (Label)grpTatilya.Controls["lbl_tatilyaIsim"]; //oto ismi
            Label lblsaatTatilya = (Label)grpTatilya.Controls["lbl_saatTatilya"]; //oto saati
            Label lblücretTatilya = (Label)grpTatilya.Controls["lbl_ücretTatilya"];
            Label lbltatilyaKoltukDurum = (Label)grpTatilya.Controls["lbl_tatilyaKoltukDurum"]; //2+1
            ...
            ((Label)grpMüsteriKayit.Controls["lbl_yön"]).Text = lblyönTatilya.Text;
            ((Label)grpMüsteriKayit.Controls["lbl_otoAdi"]).Text = lbltatilyaIsim.Text;
            ((Label)grpMüsteriKayit.Controls["lbl_kalkisSaati"]).Text = lblsaatTatilya.Text;
            ((Label)grpMüsteriKayit.Controls["lbl_ücret"]).Text = lblücretTatilya.Text;
            ((Label)grpMüsteriKayit.Controls["lbl_koltukBilgi"]).Text = lbltatilyaKoltukDurum.Text;
            #endregion        
