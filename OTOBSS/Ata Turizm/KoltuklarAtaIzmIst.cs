...
{
    public partial class KoltuklarAtaIzmIst : Form
    {
        OtobüsSistemServis service;
        string koltukN;
        int sonuc;
        MüsteriKayitEkrani müsteriKayitEkran;
        public KoltuklarAtaIzmIst()
        {
            InitializeComponent();
        ...
        private void müsteriKayit(string koltukNom, object sender)
        {
            ...
            GroupBox grpAta = (GroupBox)frmIzmirYön.Controls["grp_ata"];
            //Otobüsler sayfasındaki labeller alındı
            Label lblyönAta = (Label)grpAta.Controls["lbl_yönAta"]; //kalkış-varış yeri
            Label lblataIsim = (Label)grpAta.Controls["lbl_ataIsim"]; //oto ismi
            Label lblsaatAta = (Label)grpAta.Controls["lbl_saatAta"]; //oto saati
            Label lblücretAta = (Label)grpAta.Controls["lbl_ücretAta"];
            Label lblataKoltukDurum = (Label)grpAta.Controls["lbl_ataKoltukDurum"]; //2+1
            ...
            ((Label)grpMüsteriKayit.Controls["lbl_yön"]).Text = lblyönAta.Text;
            ((Label)grpMüsteriKayit.Controls["lbl_otoAdi"]).Text = lblataIsim.Text;
            ((Label)grpMüsteriKayit.Controls["lbl_kalkisSaati"]).Text = lblsaatAta.Text;
            ((Label)grpMüsteriKayit.Controls["lbl_ücret"]).Text = lblücretAta.Text;
            ((Label)grpMüsteriKayit.Controls["lbl_koltukBilgi"]).Text = lblataKoltukDurum.Text;
            #endregion        
