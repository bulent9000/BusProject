...
{
    public partial class KoltuklarSiratAnkIst : Form
    {
        OtobüsSistemServis service;
        string koltukN;
        int sonuc;
        MüsteriKayitEkrani müsteriKayitEkran;
        public KoltuklarSiratAnkIst()
        {
            InitializeComponent();
        ...
        private void müsteriKayit(string koltukNom, object sender)
        {
            ...
            GroupBox grpSirat = (GroupBox)frmAnkaraYön.Controls["grp_sirat"];
            ...
            Label lblyönSirat = (Label)grpSirat.Controls["lbl_yönSirat"]; //kalkış-varış yeri
            Label lblSiratIsim = (Label)grpSirat.Controls["lbl_siratIsim"]; //oto ismi
            Label lblsaatSirat = (Label)grpSirat.Controls["lbl_saatSirat"]; //oto saati
            Label lblücretSirat = (Label)grpSirat.Controls["lbl_ücretSirat"];
            Label lblSiratKoltukDurum = (Label)grpSirat.Controls["lbl_siratKoltukDurum"]; //2+1
            ...
            ((Label)grpMüsteriKayit.Controls["lbl_yön"]).Text = lblyönSirat.Text;
            ((Label)grpMüsteriKayit.Controls["lbl_otoAdi"]).Text = lblSiratIsim.Text;
            ((Label)grpMüsteriKayit.Controls["lbl_kalkisSaati"]).Text = lblsaatSirat.Text;
            ((Label)grpMüsteriKayit.Controls["lbl_ücret"]).Text = lblücretSirat.Text;
            ((Label)grpMüsteriKayit.Controls["lbl_koltukBilgi"]).Text = lblSiratKoltukDurum.Text;
            #endregion        
