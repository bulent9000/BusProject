...
{
    public partial class KoltuklarSüratIzmBur : Form
    {
        OtobüsSistemServis service;
        string koltukN;
        int sonuc;
        MüsteriKayitEkrani müsteriKayitEkran;
        public KoltuklarSüratIzmBur()
        {
            InitializeComponent();
        ...
        private void müsteriKayit(string koltukNom, object sender)
        {
            ...
            GroupBox grpSürat = (GroupBox)frmIzmirYön.Controls["grp_sürat"];
            //Otobüsler sayfasındaki labeller alındı
            Label lblyönSürat = (Label)grpSürat.Controls["lbl_yönSürat"]; //kalkış-varış yeri
            Label lblsüratIsim = (Label)grpSürat.Controls["lbl_süratIsim"]; //oto ismi
            Label lblsaatSürat = (Label)grpSürat.Controls["lbl_saatSürat"]; //oto saati
            Label lblücretSürat = (Label)grpSürat.Controls["lbl_ücretSürat"];
            Label lblsüratKoltukDurum = (Label)grpSürat.Controls["lbl_süratKoltukDurum"]; //2+1
            ...
            ((Label)grpMüsteriKayit.Controls["lbl_yön"]).Text = lblyönSürat.Text;
            ((Label)grpMüsteriKayit.Controls["lbl_otoAdi"]).Text = lblsüratIsim.Text;
            ((Label)grpMüsteriKayit.Controls["lbl_kalkisSaati"]).Text = lblsaatSürat.Text;
            ((Label)grpMüsteriKayit.Controls["lbl_ücret"]).Text = lblücretSürat.Text;
            ((Label)grpMüsteriKayit.Controls["lbl_koltukBilgi"]).Text = lblsüratKoltukDurum.Text;
            #endregion        
