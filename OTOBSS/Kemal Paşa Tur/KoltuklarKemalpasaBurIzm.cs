...
{
    public partial class KoltuklarKemalpasaBurIzm : Form
    {
        OtobüsSistemServis service;
        string koltukN;
        int sonuc;
        MüsteriKayitEkrani müsteriKayitEkran;
        public KoltuklarKemalpasaBurIzm()
        {
            InitializeComponent();
        ...
        private void müsteriKayit(string koltukNom, object sender)
        {
            ...
            //aktarıldı
           ////////// BursaYönFirmalar frmBursaYön = new BursaYönFirmalar();
            #region
            Form frmBursaYön = Application.OpenForms["BursaYönFirmalar"];
            GroupBox grpkemalpasa = (GroupBox)frmBursaYön.Controls["grp_kemalpasa"];
            ...
            Label lblyönKemalPasa = (Label)grpkemalpasa.Controls["lbl_yönKemalPasa"]; //kalkış-varış yeri
            Label lblisimKemalpasa = (Label)grpkemalpasa.Controls["lbl_isimKemalpasa"]; //oto ismi
            Label lblsaatKemalPasa = (Label)grpkemalpasa.Controls["lbl_saatKemalPasa"]; //oto saati
            Label lblücretKemalPasa = (Label)grpkemalpasa.Controls["lbl_ücretKemalPasa"];
            Label lblkemalpasaKoltukDurum = (Label)grpkemalpasa.Controls["lbl_kemalpasaKoltukDurum"]; //2+1
            ...
            ((Label)grpMüsteriKayit.Controls["lbl_yön"]).Text = lblyönKemalPasa.Text;
            ((Label)grpMüsteriKayit.Controls["lbl_otoAdi"]).Text = lblisimKemalpasa.Text;
            ((Label)grpMüsteriKayit.Controls["lbl_kalkisSaati"]).Text = lblsaatKemalPasa.Text;
            ((Label)grpMüsteriKayit.Controls["lbl_ücret"]).Text = lblücretKemalPasa.Text;
            ((Label)grpMüsteriKayit.Controls["lbl_koltukBilgi"]).Text = lblkemalpasaKoltukDurum.Text;
            #endregion        
