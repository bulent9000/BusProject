...
{
    public partial class KoltuklarOzcanlarIstBur : Form
    {
        OtobüsSistemServis service;
        string koltukN;
        int sonuc;
        MüsteriKayitEkrani müsteriKayitEkran;
        public KoltuklarOzcanlarIstBur()
        {
            InitializeComponent();
        ...
        private void müsteriKayit(string koltukNom, object sender)
        {
            ...
            #region
            Form frmIstYön = Application.OpenForms["IstanbulYönFirmalar"];
            GroupBox grpOz = (GroupBox)frmIstYön.Controls["grp_öz"];
            ...
            Label lblyönÖzcanlar = (Label)grpOz.Controls["lbl_yönÖzcanlar"]; //kalkış-varış yeri
            Label lblözIsim = (Label)grpOz.Controls["lbl_özIsim"]; //oto ismi
            Label lblsaatÖzcanlar = (Label)grpOz.Controls["lbl_saatÖzcanlar"]; //oto saati
            Label lblücretÖzcanlar = (Label)grpOz.Controls["lbl_ücretÖzcanlar"];
            Label lblözKoltukDurum = (Label)grpOz.Controls["lbl_özKoltukDurum"]; //2+1
            ...
            ((Label)grpMüsteriKayit.Controls["lbl_yön"]).Text = lblyönÖzcanlar.Text;
            ((Label)grpMüsteriKayit.Controls["lbl_otoAdi"]).Text = lblözIsim.Text;
            ((Label)grpMüsteriKayit.Controls["lbl_kalkisSaati"]).Text = lblsaatÖzcanlar.Text;
            ((Label)grpMüsteriKayit.Controls["lbl_ücret"]).Text = lblücretÖzcanlar.Text;
            ((Label)grpMüsteriKayit.Controls["lbl_koltukBilgi"]).Text = lblözKoltukDurum.Text;
            #endregion        
