...
{
    public partial class KoltuklarYesillerDiyariBurAnk : Form
    {
        OtobüsSistemServis service;
        string koltukN;
        int sonuc;
        MüsteriKayitEkrani müsteriKayitEkran;
        public KoltuklarYesillerDiyariBurAnk()
        {
            InitializeComponent();
        ...
        private void müsteriKayit(string koltukNom, object sender)
        {
            ...
            GroupBox grpyesillerDiyari = (GroupBox)frmBursaYön.Controls["grp_yesillerDiyari"];
            ...
            Label lblyönYesillerDiyari = (Label)grpyesillerDiyari.Controls["lbl_yönYesillerDiyari"]; //kalkış-varış yeri
            Label lbl_yesillerIsim = (Label)grpyesillerDiyari.Controls["lbl_yesillerIsim"]; //oto ismi
            Label lbl_saatYesillerDiyari = (Label)grpyesillerDiyari.Controls["lbl_saatYesillerDiyari"]; //oto saati
            Label lblücretYesillerDiyari = (Label)grpyesillerDiyari.Controls["lbl_ücretYesillerDiyari"];
            Label lblyesillerKoltukDurum = (Label)grpyesillerDiyari.Controls["lbl_yesillerKoltukDurum"]; //2+1
            ...
            ((Label)grpMüsteriKayit.Controls["lbl_yön"]).Text = lblyönYesillerDiyari.Text;
            ((Label)grpMüsteriKayit.Controls["lbl_otoAdi"]).Text = lbl_yesillerIsim.Text;
            ((Label)grpMüsteriKayit.Controls["lbl_kalkisSaati"]).Text = lbl_saatYesillerDiyari.Text;
            ((Label)grpMüsteriKayit.Controls["lbl_ücret"]).Text = lblücretYesillerDiyari.Text;
            ((Label)grpMüsteriKayit.Controls["lbl_koltukBilgi"]).Text = lblyesillerKoltukDurum.Text;
            #endregion        
