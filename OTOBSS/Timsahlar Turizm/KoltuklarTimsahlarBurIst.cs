...
{
    public partial class KoltuklarTimsahlarBurIst : Form
    {
        OtobüsSistemServis service;
        string koltukN;
        int sonuc;
        MüsteriKayitEkrani müsteriKayitEkran;
        public KoltuklarTimsahlarBurIst()
        {
            InitializeComponent();
        ...
        private void müsteriKayit(string koltukNom, object sender)
        {
            ...
            #region
            Form frmBursaYön = Application.OpenForms["BursaYönFirmalar"];
            GroupBox grptimsahlar = (GroupBox)frmBursaYön.Controls["grp_timsahlar"];
            //Otobüsler sayfasındaki labeller alındı sol kısım hayali isim.Önemi yok.Altta müşteri kayıt
            //ekranına akrtarılmak için  isim verildi
            Label lblyönTimsahlar = (Label)grptimsahlar.Controls["lbl_yönTimsahlar"]; //kalkış-varış yeri
            Label lbltimsahlarIsim = (Label)grptimsahlar.Controls["lbl_timsahlarIsim"]; //oto ismi
            Label lblsaatTimsahlar = (Label)grptimsahlar.Controls["lbl_saatTimsahlar"]; //oto saati
            Label lblücretTimsahlar = (Label)grptimsahlar.Controls["lbl_ücretTimsahlar"];
            Label lbltimsahlarKoltukDurum = (Label)grptimsahlar.Controls["lbl_timsahlarKoltukDurum"]; //2+1

            //müşteri kayıt ekranına aktarılıyor
            müsteriKayitEkran = new MüsteriKayitEkrani(); //EKSTRA
            GroupBox grpMüsteriBilgi = (GroupBox)müsteriKayitEkran.Controls["grpMüsteriBilgi"]; //EKSTRA
            Form frm = Application.OpenForms["Form1"];   //EKSTRA
            DateTimePicker dtp = (DateTimePicker)frm.Controls["dtp_yolculukTarih"];  //EKSTRA
            ((Label)grpMüsteriBilgi.Controls["lbl_tarihSaat"]).Text = dtp.Text;  //EKSTRA
            ...
            ((Label)grpMüsteriKayit.Controls["lbl_yön"]).Text = lblyönTimsahlar.Text;
            ((Label)grpMüsteriKayit.Controls["lbl_otoAdi"]).Text = lbltimsahlarIsim.Text;
            ((Label)grpMüsteriKayit.Controls["lbl_kalkisSaati"]).Text = lblsaatTimsahlar.Text;
            ((Label)grpMüsteriKayit.Controls["lbl_ücret"]).Text = lblücretTimsahlar.Text;
            ((Label)grpMüsteriKayit.Controls["lbl_koltukBilgi"]).Text = lbltimsahlarKoltukDurum.Text;
            #endregion        
        ...
        private void kol38_Click(object sender, EventArgs e)
        {
            koltukN = kol38.Text;
            koltukSorgu(koltukN, sender);
            renkDegis(sender);
        ...
        private void kol39_Click(object sender, EventArgs e)
        {
            koltukN = kol39.Text;
            koltukSorgu(koltukN, sender);
            renkDegis(sender);
        ...
        private void kol40_Click(object sender, EventArgs e)
        {
            koltukN = kol40.Text;
            koltukSorgu(koltukN, sender);
            renkDegis(sender);
        ...
        private void kol41_Click(object sender, EventArgs e)
        {
            koltukN = kol41.Text;
            koltukSorgu(koltukN, sender);
            renkDegis(sender);
        ...
        private void kol42_Click(object sender, EventArgs e)
        {
            koltukN = kol42.Text;
            koltukSorgu(koltukN, sender);
            renkDegis(sender);
        ...
        private void kol43_Click(object sender, EventArgs e)
        {
            koltukN = kol43.Text;
            koltukSorgu(koltukN, sender);
            renkDegis(sender);
        ...
        private void kol44_Click(object sender, EventArgs e)
        {
            koltukN = kol44.Text;
            koltukSorgu(koltukN, sender);
            renkDegis(sender);
        ...
        private void kol45_Click(object sender, EventArgs e)
        {
            koltukN = kol45.Text;
            koltukSorgu(koltukN, sender);
            renkDegis(sender);
        ...
        private void kol46_Click(object sender, EventArgs e)
        {
            koltukN = kol46.Text;
            koltukSorgu(koltukN, sender);
            renkDegis(sender);
