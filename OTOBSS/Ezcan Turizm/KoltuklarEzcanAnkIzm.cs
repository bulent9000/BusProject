...
{
    public partial class KoltuklarEzcanAnkIzm : Form
    {
        OtobüsSistemServis service;
        string koltukN;
        int sonuc;
        MüsteriKayitEkrani müsteriKayitEkran;
        public KoltuklarEzcanAnkIzm()
        {
            InitializeComponent();
        ...
        private void müsteriKayit(string koltukNom, object sender)
        {
            ...
            GroupBox grpEzcan = (GroupBox)frmAnkaraYön.Controls["grp_ezcan"];
            ...
            Label lblyönEzcan = (Label)grpEzcan.Controls["lbl_yönEzcan"]; //kalkış-varış yeri
            Label lblezcanIsim = (Label)grpEzcan.Controls["lbl_ezcanIsim"]; //oto ismi
            Label lblsaatEzcan = (Label)grpEzcan.Controls["lbl_saatEzcan"]; //oto saati
            Label lbl_ücretEzcan = (Label)grpEzcan.Controls["lbl_ücretEzcan"];
            Label lbl_ezcanKoltukDurum = (Label)grpEzcan.Controls["lbl_ezcanKoltukDurum"]; //2+1
            ...
            ((Label)grpMüsteriKayit.Controls["lbl_yön"]).Text = lblyönEzcan.Text;
            ((Label)grpMüsteriKayit.Controls["lbl_otoAdi"]).Text = lblezcanIsim.Text;
            ((Label)grpMüsteriKayit.Controls["lbl_kalkisSaati"]).Text = lblsaatEzcan.Text;
            ((Label)grpMüsteriKayit.Controls["lbl_ücret"]).Text = lbl_ücretEzcan.Text;
            ((Label)grpMüsteriKayit.Controls["lbl_koltukBilgi"]).Text = lbl_ezcanKoltukDurum.Text;
            #endregion        
