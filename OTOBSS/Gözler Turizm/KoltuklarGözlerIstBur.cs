...
{
    public partial class KoltuklarGözlerIstBur : Form
    {
        OtobüsSistemServis service;
        string koltukN;
        int sonuc;
        MüsteriKayitEkrani müsteriKayitEkran;
        public KoltuklarGözlerIstBur()
        {
            InitializeComponent();
        ...
        private void müsteriKayit(string koltukNom, object sender)
        {
            ...
            GroupBox grpGözler = (GroupBox)frmIstYön.Controls["grp_gözler"];
            ...
            Label lblyönGözler = (Label)grpGözler.Controls["lbl_yönGözler"]; //kalkış-varış yeri
            Label lblgözlerIsim = (Label)grpGözler.Controls["lbl_gözlerIsim"]; //oto ismi
            Label lblsaatGözler = (Label)grpGözler.Controls["lbl_saatGözler"]; //oto saati
            Label lblücretGözler = (Label)grpGözler.Controls["lbl_ücretGözler"];
            Label lblgözlerKoltukDurum = (Label)grpGözler.Controls["lbl_gözlerKoltukDurum"]; //2+1
            ...
            ((Label)grpMüsteriKayit.Controls["lbl_yön"]).Text = lblyönGözler.Text;
            ((Label)grpMüsteriKayit.Controls["lbl_otoAdi"]).Text = lblgözlerIsim.Text;
            ((Label)grpMüsteriKayit.Controls["lbl_kalkisSaati"]).Text = lblsaatGözler.Text;
            ((Label)grpMüsteriKayit.Controls["lbl_ücret"]).Text = lblücretGözler.Text;
            ((Label)grpMüsteriKayit.Controls["lbl_koltukBilgi"]).Text = lblgözlerKoltukDurum.Text;
            #endregion        
