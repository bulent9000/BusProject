...
namespace OTOBSS
{
    public partial class KoltuklarSonTurAnkBur : Form
    {
        OtobüsSistemServis service;
        string koltukN;
        int sonuc;
        MüsteriKayitEkrani müsteriKayitEkran;
        public KoltuklarSonTurAnkBur()
        {
            InitializeComponent();
        ...
        private void müsteriKayit(string koltukNom,object sender)
        {
            ...
            //aktarıldı
            //AnkaraYönFirmalar frmAnkaraYön = new AnkaraYönFirmalar();
            #region
            Form frmAnkaraYön = Application.OpenForms["AnkaraYönFirmalar"];
            
            GroupBox grpSontur = (GroupBox)frmAnkaraYön.Controls["grp_Sontur"];
            //Otobüsler sayfasındaki labeller alındı
            Label lblyönSontur=(Label)grpSontur.Controls["lbl_yönSonTur"]; //kalkış-varış yeri
            Label lblSonturIsim = (Label)grpSontur.Controls["lbl_SonturIsim"]; //oto ismi
            Label lblsaatSonTur = (Label)grpSontur.Controls["lbl_saatSonTur"]; //oto saati
            Label lblücretSonTur = (Label)grpSontur.Controls["lbl_ücretSonTur"]; 
            Label lblKoltukDurum = (Label)grpSontur.Controls["lbl_KoltukDurum"]; //2+1
            ...
            ((Label)grpMüsteriKayit.Controls["lbl_yön"]).Text = lblyönSontur.Text;
            ((Label)grpMüsteriKayit.Controls["lbl_otoAdi"]).Text = lblSonturIsim.Text;
            ((Label)grpMüsteriKayit.Controls["lbl_kalkisSaati"]).Text = lblsaatSonTur.Text;
            ((Label)grpMüsteriKayit.Controls["lbl_ücret"]).Text = lblücretSonTur.Text;
            ((Label)grpMüsteriKayit.Controls["lbl_koltukBilgi"]).Text = lblKoltukDurum.Text;
            #endregion
