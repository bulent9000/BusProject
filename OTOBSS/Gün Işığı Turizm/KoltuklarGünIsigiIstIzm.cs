...
{
    public partial class KoltuklarGünIsigiIstIzm : Form
    {
        OtobüsSistemServis service;
        string koltukN;
        int sonuc;
        MüsteriKayitEkrani müsteriKayitEkran;
        public KoltuklarGünIsigiIstIzm()
        {
            InitializeComponent();
        ...
        private void müsteriKayit(string koltukNom, object sender)
        {
            ...
            GroupBox grpgünIsigi = (GroupBox)frmIstYön.Controls["grp_günIsigi"];
            ...
            Label lblyönGünIsigi = (Label)grpgünIsigi.Controls["lbl_yönGünIsigi"]; //kalkış-varış yeri
            Label lblgünIsigiIsim = (Label)grpgünIsigi.Controls["lbl_günIsigiIsim"]; //oto ismi
            Label lblsaatGünIsigi = (Label)grpgünIsigi.Controls["lbl_saatGünIsigi"]; //oto saati
            Label lblücretGünIsigi = (Label)grpgünIsigi.Controls["lbl_ücretGünIsigi"];
            Label lblgünIsigiKoltukDurum = (Label)grpgünIsigi.Controls["lbl_günIsigiKoltukDurum"]; //2+1
            ...
            ((Label)grpMüsteriKayit.Controls["lbl_yön"]).Text = lblyönGünIsigi.Text;
            ((Label)grpMüsteriKayit.Controls["lbl_otoAdi"]).Text = lblgünIsigiIsim.Text;
            ((Label)grpMüsteriKayit.Controls["lbl_kalkisSaati"]).Text = lblsaatGünIsigi.Text;
            ((Label)grpMüsteriKayit.Controls["lbl_ücret"]).Text = lblücretGünIsigi.Text;
            ((Label)grpMüsteriKayit.Controls["lbl_koltukBilgi"]).Text = lblgünIsigiKoltukDurum.Text;
            #endregion        
