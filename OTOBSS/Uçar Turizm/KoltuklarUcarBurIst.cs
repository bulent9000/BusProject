...
{
    public partial class KoltuklarUcarBurIst : Form
    {
        OtobüsSistemServis service;
        string koltukN;
        int sonuc;
        MüsteriKayitEkrani müsteriKayitEkran;
        public KoltuklarUcarBurIst()
        {
            InitializeComponent();
        ...
        private void müsteriKayit(string koltukNom, object sender)
        {
            ...
            GroupBox grpUcar = (GroupBox)frmBursaYön.Controls["grp_ucar"];
            ...
            Label lblyönUcar = (Label)grpUcar.Controls["lbl_yönUcar"]; //kalkış-varış yeri
            Label lblucarIsim = (Label)grpUcar.Controls["lbl_ucarIsim"]; //oto ismi
            Label lblsaatUcar = (Label)grpUcar.Controls["lbl_saatUcar"]; //oto saati
            Label lblücretUcar = (Label)grpUcar.Controls["lbl_ücretUcar"];
            Label lblucarKoltukDurum = (Label)grpUcar.Controls["lbl_ucarKoltukDurum"]; //2+1
            ...
            ((Label)grpMüsteriKayit.Controls["lbl_yön"]).Text = lblyönUcar.Text;
            ((Label)grpMüsteriKayit.Controls["lbl_otoAdi"]).Text = lblucarIsim.Text;
            ((Label)grpMüsteriKayit.Controls["lbl_kalkisSaati"]).Text = lblsaatUcar.Text;
            ((Label)grpMüsteriKayit.Controls["lbl_ücret"]).Text = lblücretUcar.Text;
            ((Label)grpMüsteriKayit.Controls["lbl_koltukBilgi"]).Text = lblucarKoltukDurum.Text;
            #endregion        
